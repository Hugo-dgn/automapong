...
agent1 = agents.HumanAgent(player=1) # touches a et q pour le contrôler
agent2 = agents.SimpleAgent(name="simple")

state1, state2 = env.reset() # l'environnement donne les états initiaux
